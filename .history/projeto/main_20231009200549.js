...
class Cartao{
    ...
    // Adicionando os event listeners de drag and drop
    this.cartao.setAttribute('draggable', true);
    this.cartao.addEventListener('dragstart', (e) => this.iniciarArrasto(e));
    this.cartao.addEventListener('dragover', (e) => this.permitirSoltar(e));
    this.cartao.addEventListener('drop', (e) => this.soltarTarefa(e));
}
    renderizar(){
